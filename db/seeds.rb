Listing.create!([
  { title: 'Parliament House', street_address: 'Spring St, East Melbourne VIC 3002', city: 'Melbourne', country_code: 'au', bed_count: rand(1..100), bedroom_count: 100, bathroom_count: 100, description: 'There is a new government initiative to rent out government buildings to provide shelter for normal people.', night_fee_cents: 5000, cleaning_fee_cents: 500 },
  
  { title: 'Mt Krakatoa', street_address: 'South Lampung Regency, Lampung', city: 'Some city covered in volcanic ash by now', country_code: 'pw', bed_count: 200, bedroom_count: 200, bathroom_count: 2, description: 'A really hot location tourists are staying at this summer, emphasis on hot.', night_fee_cents: 10000, cleaning_fee_cents: 1000 },
